...
const Graph = () => 
    <div id="container" className="flex-1 pt-10 pb-20 bg-login flex-row min-h-screen w-sm" style={{ paddingLeft: '10%', paddingRight: '10%' } }>
        <div id="factor_umbers" className="space-y-1 p-8 pl-10 pr-10 max-h-screen bg-green min-w-full border-4 border-solid rounded-3xl border-cream border-dashed" >    
