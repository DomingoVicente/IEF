module.exports = {
    ...
    sourceWorkbook1Sheets: ['Superf_transicion_GL','Superf_transicion_GL','Superf_transicion_GL','Superf_transicion_GL','Superf_transicion_GL','Superf_transicion_GL'], //plantillas bda workbookBDA buscarb
